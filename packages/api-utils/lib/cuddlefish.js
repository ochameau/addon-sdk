...
const Loader = {
  ...
  require: function require(base, id) {
    let manifest = this.manifest[base], requirer = this.modules[base];
    ...
    let module = this._require(id, path);
  ...
  // This internal require allows to load a module off-manifest.
  // Mainly used to load main module.
  _require: function _require(id, path) {
...
/*
  Hacks in order to trick the manifest scanner and allows loading this modules
  from bootstrap.js:startup() and process.js:process():
    require('api-utils/chrome-entry-point');
    require('api-utils/remote-entry-point');
*/
